    ...
    <>
      ...
      <div style={{
        ...
        <section ref={heroRef} style={{
          ...
          <div style={{
            position: "absolute", width: "900px", height: "700px", borderRadius: "50%",
            background: "radial-gradient(ellipse, rgba(255,100,0,0.28) 0%, rgba(255,60,0,0.10) 40%, transparent 70%)",
            top: "50%", left: "50%", transform: "translate(-50%, -52%)",
            filter: "blur(60px)", pointerEvents: "none", animation: "glowPulse 4s ease-in-out infinite",
          }} />
          <div style={{
            position: "absolute", width: "600px", height: "500px", borderRadius: "50%",
            background: "radial-gradient(ellipse, rgba(255,180,30,0.18) 0%, transparent 65%)",
            top: "38%", left: "50%", transform: "translate(-50%, -50%)",
            filter: "blur(80px)", pointerEvents: "none", animation: "glowPulse 4s ease-in-out infinite 1s",
          }} />
          <div style={{
            ...
            filter: "blur(90px)", pointerEvents: "none", animation: "glowPulse 5s ease-in-out infinite 0.5s",
          }} />
          <div style={{
            position: "absolute", width: "500px", height: "400px", borderRadius: "50%",
            background: "radial-gradient(ellipse, rgba(255,140,0,0.13) 0%, transparent 70%)",
            top: "45%", left: "80%", transform: "translate(-50%, -50%)",
            filter: "blur(90px)", pointerEvents: "none", animation: "glowPulse 5s ease-in-out infinite 1.5s",
          }} />
          <div style={{
            position: "absolute", width: "800px", height: "300px", borderRadius: "50%",
          ...
          <div style={{
            ...
            opacity: heroVisible ? 0.3 : 0, transition: "opacity 1.2s ease 0.8s", whiteSpace: "nowrap",
          }}>
          ...
          <div style={{
            ...
            transform: "translateY(-50%) rotate(90deg)", transformOrigin: "center center",
            opacity: heroVisible ? 0.3 : 0, transition: "opacity 1.2s ease 0.9s", whiteSpace: "nowrap",
          }}>
          ...
          <div style={{
            ...
            opacity: heroVisible ? 1 : 0, transform: heroVisible ? "none" : "translateY(-8px)", transition: "all 1s ease 0.3s",
          }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              opacity: heroVisible ? 1 : 0, transform: heroVisible ? "none" : "translateY(14px)", transition: "all 0.9s ease 0.1s",
            }}>
            ...
            <div style={{ marginBottom: "12px", overflow: "hidden", opacity: heroVisible ? 1 : 0, transform: heroVisible ? "none" : "translateY(30px)", transition: "all 1s cubic-bezier(.22,1,.36,1) 0.2s" }}>
            ...
            <div style={{ marginBottom: "12px", overflow: "hidden", opacity: heroVisible ? 1 : 0, transform: heroVisible ? "none" : "translateY(30px)", transition: "all 1s cubic-bezier(.22,1,.36,1) 0.32s" }}>
            ...
            <div style={{ marginBottom: "48px", overflow: "hidden", opacity: heroVisible ? 1 : 0, transform: heroVisible ? "none" : "translateY(30px)", transition: "all 1s cubic-bezier(.22,1,.36,1) 0.44s" }}>
            ...
            <div style={{ display: "flex", gap: "16px", justifyContent: "center", flexWrap: "wrap", opacity: heroVisible ? 1 : 0, transform: heroVisible ? "none" : "translateY(16px)", transition: "all 1s ease 0.72s" }}>
              ...
              <a href="#contact" style={{ padding: "17px 40px", background: "transparent", color: "rgba(255,255,255,0.65)", border: "1px solid rgba(255,255,255,0.18)", borderRadius: "100px", fontWeight: "500", fontSize: "13px", letterSpacing: "1.5px", textTransform: "uppercase", textDecoration: "none", backdropFilter: "blur(12px)", fontFamily: "'DM Sans', sans-serif" }}>Contact Us</a>
            </div>
          </div>
        ...
        {/* Stats bar */}
        <div style={{ position: "relative", zIndex: 2, borderTop: "1px solid rgba(255,255,255,0.06)", borderBottom: "1px solid rgba(255,255,255,0.06)", background: "rgba(255,255,255,0.02)", display: "flex", justifyContent: "center", flexWrap: "wrap", gap: "0" }}>
          {[
